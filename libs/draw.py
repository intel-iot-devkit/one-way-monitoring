...
class Draw:
    ...
    @staticmethod
    def arrowed_line(frame, coords, color="yellow", thickness=2, tipLength=0.04):
        xmin, ymin, xmax, ymax = coords
        cv2.arrowedLine(frame, (xmin, ymin), (xmax, ymax), COLOR[color],
                        thickness, line_type=cv2.LINE_AA, tipLength=tipLength)
